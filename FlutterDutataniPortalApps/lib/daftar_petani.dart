...
import 'package:dutatani_mapping_iot/data_lahan.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:dutatani_mapping_iot/model/petani.dart';
import 'tambah_petani.dart';

class DaftarPetani extends StatefulWidget {
  @override
  _DaftarPetaniState createState() => _DaftarPetaniState();
}

class _DaftarPetaniState extends State<DaftarPetani> {
  List<Petani> _list = [];
  List<Petani> _search = [];
  var loading = true;
  ...
  Future<Void> fetchData() async {
    ...
    _list.clear();
    final response =
        await http.get("http://genesis.dutatani.id/si_mapping/api/read_petani.php");
                                ...
                                return Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                     ...
                                     onTap: (){
                                      // Navigator.push(context, MaterialPageRoute(builder: (context){return DataLahan(data:b);} ,),);
                                    },
                                  )
                                );
                              },
                                ...
                                itemBuilder: (context, i) {
                                  ...
                                  return Container(
                                    ...
                                    title: Text(
                                      ...
                                      onTap: (){
                                      // Navigator.push(context, MaterialPageRoute(builder: (context) => DataLahan(data:a),),);
                                    },
